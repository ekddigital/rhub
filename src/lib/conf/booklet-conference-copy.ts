...
export const CONFERENCE_INTRO_PARAGRAPHS = [
  ...
  `The conference takes place from Friday, 24 July through Monday, 27 July 2026 at the ${CONF_2026.venue} in Qihe County, ${CONF_2026.province} Province. Jinan, the capital of Shandong, is widely known as the City of Springs for its historic artesian wells and long cultural heritage; Shandong is the birthplace of Confucian thought and one of China's great provincial centers of learning and industry. Our venue in Qihe County offers a dedicated setting for plenary sessions, fellowship, and recreation — with conference facilities, spa amenities, and sports grounds for football and other outdoor activities.`,
