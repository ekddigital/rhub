...
export const DEFAULT_CHAIRMAN_ADDRESS = [
  ...
  "I extend my highest esteem and warmest welcome to His Excellency the Ambassador of the Republic of Liberia to the People's Republic of China, to our distinguished guests, and to every delegate who has traveled to Jinan. Your presence affirms the unity of our union and the dignity of the occasion we share. I also wish to express our deepest appreciation to National President Hon. Olano Teah Bloh and every member of the National Executive Committee for entrusting this Conference Committee with the responsibility of organizing this historic 20th Anniversary Conference. Every member of the NEC is a blessing to this Union — their dedication, sacrifice, and hard work make moments like this possible, and we, the Conference Committee, are grateful for them and stand in full recognition of their service.",
