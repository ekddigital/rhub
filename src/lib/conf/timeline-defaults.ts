...
export const INITIAL_TIMELINE: DefaultTimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "Package tiers and payment policy approved using the current package model, with affordable options maintained across categories.",
  ...
  },
  {
    ...
    description:
      "Final delegate travel guidance, check-in details, and day-1 brief sent before conference week.",
