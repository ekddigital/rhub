...
repeat the same to the others as well.
...
Section B covers DiDi/Taxi for each arrival stations.
...
we can say that it is the last stop before getting on teh bus, the last bus stop area

all public transits can be change to public transport

all privatae cars can be change to DiDi

also change the Taxis accept to TAxi accepts

for the conference booklet, also add theme on it and sub theme like it is on the navigatoin guide

and where we have Conferencer Booklet we can change it to 20th Annaual Conference & 179th Independence Day Celebration of Liberia

Held in Jinan City, Shandong Province

where this is

Est. July 2006 we can have the theme
...
carry the writing up for the message of people and make the text color black

use the 3 format that was on the conference committee so that the coc can do the same and city president too

remove Edwin Hena Dawolo from the AEC
...
can we work on all of them

note that i am talking about the rhub/ project
