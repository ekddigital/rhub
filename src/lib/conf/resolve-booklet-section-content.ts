...
export const DEFAULT_CHAIRMAN_ADDRESS = [
  ...
  "I extend my highest esteem and warmest welcome to His Excellency the Ambassador of the Republic of Liberia to the People's Republic of China, to our distinguished guests, and to every delegate who traveled to Jinan. Your presence affirmed the unity of our union and the dignity of the occasion we shared. I also wish to express our deepest appreciation to National President Hon. Olano Teah Bloh and every member of the National Executive Committee for entrusting this Conference Committee with the responsibility of organizing this historic 20th Anniversary Conference. Every member of the NEC is a blessing to this Union — their dedication, sacrifice, and hard work made moments like this possible, and we, the Conference Committee, are grateful for them and stand in full recognition of their service.",
  "To every member of the Conference Committee, I offer heartfelt thanks for your tireless commitment. We met consistently every Thursday to plan this conference, with each session averaging at least two hours — and many meetings that were intended to last one hour naturally continued for two because of your diligence and care for excellence. I deeply value this team of committed individuals who sacrificed personal time every week to serve LSUIC. Together with the steady guidance of the NEC, your sacrifices and dedication will not be in vain; your work will be rewarded in ways beyond expectation.",
...
export const DEFAULT_PRESIDENT_ADDRESS = [
  ...
  "Every visa processed, every student welcomed at the airport, every welfare disbursement, every prayer shared, and every cultural festival celebrated was a moment that defines who we are. LSUIC is not just an organization. It is a family. It is a home away from home.",
