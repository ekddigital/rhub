...
1.	Make simple sentences --- Ex: Ruphine is a girl…. Girl loves money …. Money is love …. Love is fake …. 
2.	Conversation …… Are you ready?
3.	Pick and Act ---- To be done in Groups ---- Paper in the bag (choose one and read what is written on it)
4.	Singing …. In a group (any song)
5.	Numbers game -----
6.	Listen and Follow ---- YES, BLUE, NO …..
Gather everyone 
1.	Feedback for day-1 from delegates
2.	Vote of thanks from the CC/NEC
3.	Closing Prayer
