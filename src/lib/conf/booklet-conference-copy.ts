...
export const PROGRAM_OUTLINE_INTRO_PARAGRAPHS = [
  `As delegates of the Liberian Student Union in China, we gather in Jinan for our 20th Annual Conference under the theme ${CONF_2026.theme}, for four days that balance conference business, fellowship, recreation, and celebration.`,
  ...
  `Please review the program carefully, arrive on time for every session, and take part actively in meetings, elections, sports, and social events. Consult the Travel Guide (a separate document) for directions from Jinan's railway stations (including Bus K904), and the Conference Introduction for delegate expectations, transportation responsibility, and dress code.`,
];
